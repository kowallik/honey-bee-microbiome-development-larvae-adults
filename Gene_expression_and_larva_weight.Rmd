...
hub_genesGO2 <- read.csv("RNA/Larvae-output/Go/GO_term_enrichment_AG_down.csv")
# keep only highly significant terms
...
```{r GO_C}
#up
C_up <- read.csv("RNA/Larvae-output/res_C_sig_up.csv")
...
GO_enrich.C %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Larvae-output/Go/GO_term_enrichment_C_up.csv")

hub_genesGO <- read.csv("RNA/Larvae-output/Go/GO_term_enrichment_C_up.csv")
# keep only highly significant terms
hub_genesGO <- hub_genesGO %>%
filter(Pvalue < 0.01) 
g <- hub_genesGO %>%
...
ggsave("RNA/Larvae-output/Go/C_up.png", height = 8, width = 9)

#down
C_down <- read.csv("RNA/Larvae-output/res_C_sig_down.csv")
...
GO_enrich.C2 %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Larvae-output/Go/GO_term_enrichment_C_down.csv")
hub_genesGO2 <- read.csv("RNA/Larvae-output/Go/GO_term_enrichment_C_down.csv")
hub_genesGO2 <- hub_genesGO2 %>%
filter(Pvalue < 0.01) 
...
ggsave("RNA/Larvae-output/Go/C_down.png", height = 8, width = 9)
```


```{r GO_LG}
#up
LG_up <- read.csv("RNA/Larvae-output/res_LG_sig_up.csv")
...
GO_enrich.LG %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Larvae-output/Go/GO_term_enrichment_LG_up.csv")

hub_genesGO <- read.csv("RNA/Larvae-output/Go/GO_term_enrichment_LG_up.csv")
# keep only highly significant terms
hub_genesGO <- hub_genesGO %>%
filter(Pvalue < 0.01) 
g <- hub_genesGO %>%
...
ggsave("RNA/Larvae-output/Go/LG_up.png", height = 8, width = 9)

#down
LG_down <- read.csv("RNA/Larvae-output/res_LG_sig_down.csv")
...
GO_enrich.LG2 %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Larvae-output/Go/GO_term_enrichment_LG_down.csv")
hub_genesGO2 <- read.csv("RNA/Larvae-output/Go/GO_term_enrichment_LG_down.csv")
hub_genesGO2 <- hub_genesGO2 %>%
filter(Pvalue < 0.01) 
...
ggplot(g2, aes(x = 0, y = Term, size = Count, color = logPv)) +
  geom_point(alpha = 0.9) +
  theme_classic()+ggtitle("RNA/LG down compared to Hive")+theme(axis.title.y = element_blank())
ggsave("RNA/Larvae-output/Go/LG_down.png", height = 8, width = 9)
```

```{r GO_LGBB}
#up
LGBB_up <- read.csv("RNA/Larvae-output/res_LGBB_sig_up.csv")
...
GO_enrich.LGBB %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Larvae-output/Go/GO_term_enrichment_LGBB_up.csv")

hub_genesGO3 <- read.csv("RNA/Larvae-output/Go/GO_term_enrichment_LGBB_up.csv")
# keep only highly significant terms
hub_genesGO3 <- hub_genesGO3 %>%
filter(Pvalue < 0.01) 
g3 <- hub_genesGO3 %>%
  mutate(logPv = log(Pvalue))
ggplot(g3, aes(x = 0, y = Term, size = Count, color = logPv)) +
  geom_point(alpha = 0.9) +
  theme_classic()+ggtitle("RNA/LGBB up compared to Hive")+theme(axis.title.y = element_blank())
ggsave("RNA/Larvae-output/Go/LGBB_up.png", height = 8, width = 9)

#down
LGBB_down <- read.csv("RNA/Larvae-output/res_LGBB_sig_down.csv")
...
GO_enrich.LGBB2 %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Larvae-output/Go/GO_term_enrichment_LGBB_down.csv")
hub_genesGO2 <- read.csv("RNA/Larvae-output/Go/GO_term_enrichment_LGBB_down.csv")
# keep only highly significant terms
hub_genesGO2 <- hub_genesGO2 %>%
filter(Pvalue < 0.01) 
...
ggsave("RNA/Larvae-output/Go/LGBB_down.png", height = 8, width = 9)
```
...
ggsave("RNA/Larvae-output/compare_against_C_lab_treatment/larva_MA_against_lab_control.png", height = 10, width = 15)
```
...
write.csv(as.data.frame(res_LG_sig), file="RNA/Larvae-output/compare_against_C_lab_treatment/res_LG_all.csv")
res_LG_sig<- subset(res_LG_sig, padj < 0.05,pAdjustMethod = "fdr")
colnames(res_LG_sig)[which(names(res_LG_sig) == "row")] <- "Gene_ID"
res_LG_sig<-merge(res_LG_sig, functions, by="Gene_ID", type="left", match="first")
write.csv(as.data.frame(res_LG_sig), file="RNA/Larvae-output/compare_against_C_lab_treatment/res_LG_sig.csv")

#How many adjusted p-values were less than 0.05?
sum(res_LG_sig$padj < 0.05, na.rm=TRUE)

res_AG_sig <- results(dds_larva, tidy=TRUE, contrast=c("condition", "adult_gut_transfer", "lab_food_nothing"))
write.csv(as.data.frame(res_AG_sig), file="RNA/Larvae-output/compare_against_C_lab_treatment/res_AG_all.csv")
res_AG_sig<- subset(res_AG_sig, padj < 0.05,pAdjustMethod = "fdr")
colnames(res_AG_sig)[which(names(res_AG_sig) == "row")] <- "Gene_ID"
res_AG_sig<-merge(res_AG_sig, functions, by="Gene_ID", type="left", match="first")
write.csv(as.data.frame(res_AG_sig), file="RNA/Larvae-output/compare_against_C_lab_treatment/res_AG_sig.csv")
sum(res_AG_sig$padj < 0.05, na.rm=TRUE)

res_LGBB_sig <- results(dds_larva, tidy=TRUE, contrast=c("condition", "larva_gut_bee_bread", "lab_food_nothing"))
write.csv(as.data.frame(res_LGBB_sig), file="RNA/Larvae-output/compare_against_C_lab_treatment/res_LGBB_all.csv")
res_LGBB_sig<- subset(res_LGBB_sig, padj < 0.05)
colnames(res_LGBB_sig)[which(names(res_LGBB_sig) == "row")] <- "Gene_ID"
res_LGBB_sig<-merge(res_LGBB_sig, functions, by="Gene_ID", type="left", match="first")
write.csv(as.data.frame(res_LGBB_sig), file="RNA/Larvae-output/compare_against_C_lab_treatment/res_LGBB_sig.csv")
sum(res_LGBB_sig$padj < 0.05, na.rm=TRUE)

res_BB_sig <- results(dds_larva, tidy=TRUE, contrast=c("condition", "bee_bread_addition", "lab_food_nothing"))
write.csv(as.data.frame(res_BB_sig), file="RNA/Larvae-output/compare_against_C_lab_treatment/res_BB_all.csv")
res_BB_sig<- subset(res_BB_sig, padj < 0.05)
colnames(res_BB_sig)[which(names(res_BB_sig) == "row")] <- "Gene_ID"
res_BB_sig<-merge(res_BB_sig, functions, by="Gene_ID", type="left", match="first")
write.csv(as.data.frame(res_BB_sig), file="RNA/Larvae-output/compare_against_C_lab_treatment/res_BB_sig.csv")
sum(res_BB_sig$padj < 0.05, na.rm=TRUE)
```

```{r GO_AG2}
#up
AG_up <- read.csv("RNA/Larvae-output/compare_against_C_lab_treatment/res_AG_sig_up.csv")
...
GO_enrich.AG %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Larvae-output/compare_against_C_lab_treatment/Go/GO_term_enrichment_AG_up.csv")

### make list
hub_genesGO <- read.csv("RNA/Larvae-output/compare_against_C_lab_treatment/Go/GO_term_enrichment_AG_up.csv")
# keep only highly significant terms
hub_genesGO <- hub_genesGO %>%
filter(Pvalue < 0.01) 
...
ggsave("RNA/Larvae-output/compare_against_C_lab_treatment/Go/AG_up.png", height = 8, width = 9)

#down
AG_down <- read.csv("RNA/Larvae-output/compare_against_C_lab_treatment/res_AG_sig_down.csv")
...
GO_enrich.AG2 %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Larvae-output/compare_against_C_lab_treatment/Go/GO_term_enrichment_AG_down.csv")
hub_genesGO2 <- read.csv("RNA/Larvae-output/compare_against_C_lab_treatment/Go/GO_term_enrichment_AG_down.csv")
# keep only highly significant terms
hub_genesGO2 <- hub_genesGO2 %>%
filter(Pvalue < 0.01) 
...
ggsave("RNA/Larvae-output/compare_against_C_lab_treatment/Go/AG_down.png", height = 8, width = 9)
```


```{r GO_BB2}
#up
BB_up <- read.csv("RNA/Larvae-output/compare_against_C_lab_treatment/res_BB_sig_up.csv")
...
GO_enrich.BB %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Larvae-output/compare_against_C_lab_treatment/Go/GO_term_enrichment_BB_up.csv")

hub_genesGO <- read.csv("RNA/Larvae-output/compare_against_C_lab_treatment/Go/GO_term_enrichment_BB_up.csv")
# keep only highly significant terms
hub_genesGO <- hub_genesGO %>%
filter(Pvalue < 0.01) 
g <- hub_genesGO %>%
...
ggsave("RNA/Larvae-output/compare_against_C_lab_treatment/Go/BB_up.png", height = 8, width = 9)

#down
BB_down <- read.csv("RNA/Larvae-output/compare_against_C_lab_treatment/res_BB_sig_down.csv")
...
GO_enrich.BB2 %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Larvae-output/compare_against_C_lab_treatment/Go/GO_term_enrichment_BB_down.csv")
hub_genesGO2 <- read.csv("RNA/Larvae-output/compare_against_C_lab_treatment/Go/GO_term_enrichment_BB_down.csv")
hub_genesGO2 <- hub_genesGO2 %>%
filter(Pvalue < 0.01) 
...
ggsave("RNA/Larvae-output/compare_against_C_lab_treatment/Go/BB_down.png", height = 8, width = 9)
```

```{r GO_LG2}
#up
LG_up <- read.csv("RNA/Larvae-output/compare_against_C_lab_treatment/res_LG_sig_up.csv")
...
GO_enrich.LG %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Larvae-output/compare_against_C_lab_treatment/Go/GO_term_enrichment_LG_up.csv")

hub_genesGO <- read.csv("RNA/Larvae-output/compare_against_C_lab_treatment/Go/GO_term_enrichment_LG_up.csv")
hub_genesGO <- hub_genesGO %>%
filter(Pvalue < 0.01) 
g <- hub_genesGO %>%
  mutate(logPv = log(Pvalue))
...
ggsave("RNA/Larvae-output/compare_against_C_lab_treatment/Go/LG_up.png", height = 8, width = 9)

#down
LG_down <- read.csv("RNA/Larvae-output/compare_against_C_lab_treatment/res_LG_sig_down.csv")
...
GO_enrich.LG2 %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Larvae-output/compare_against_C_lab_treatment/Go/GO_term_enrichment_LG_down.csv")
hub_genesGO2 <- read.csv("RNA/Larvae-output/compare_against_C_lab_treatment/Go/GO_term_enrichment_LG_down.csv")
hub_genesGO2 <- hub_genesGO2 %>%
filter(Pvalue < 0.01) 
...
ggsave("RNA/Larvae-output/compare_against_C_lab_treatment/Go/LG_down.png", height = 8, width = 9)
```

```{r GO_LGBB2}
#up
LGBB_up <- read.csv("RNA/Larvae-output/compare_against_C_lab_treatment/res_LGBB_sig_up.csv")
...
GO_enrich.LGBB %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Larvae-output/compare_against_C_lab_treatment/Go/GO_term_enrichment_LGBB_up.csv")

hub_genesGO <- read.csv("RNA/Larvae-output/compare_against_C_lab_treatment/Go/GO_term_enrichment_LGBB_up.csv")
hub_genesGO <- hub_genesGO %>%
filter(Pvalue < 0.01) 
g <- hub_genesGO %>%
  mutate(logPv = log(Pvalue))
...
ggsave("RNA/Larvae-output/compare_against_C_lab_treatment/Go/LGBB_up.png", height = 8, width = 9)

#down
LGBB_down <- read.csv("RNA/Larvae-output/compare_against_C_lab_treatment/res_LGBB_sig_down.csv")
...
GO_enrich.LGBB2 %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Larvae-output/compare_against_C_lab_treatment/Go/GO_term_enrichment_LGBB_down.csv")
hub_genesGO2 <- read.csv("RNA/Larvae-output/compare_against_C_lab_treatment/Go/GO_term_enrichment_LGBB_down.csv")
hub_genesGO2 <- hub_genesGO2 %>%
...
ggsave("RNA/Larvae-output/compare_against_C_lab_treatment/Go/LGBB_down.png", height = 8, width = 9)
```
...
dirs <- list.files(file.path("RNA/data_files/kallisto_adults/"))
quant_files <- paste0("RNA/data_files/kallisto_adults/",dirs,"/abundance.tsv")
names(quant_files) <- dirs

txi <- tximport(quant_files,type="kallisto",tx2gene = tx2gene,ignoreTxVersion = TRUE)

sampleinfo <- read.delim("RNA/data_files/metafile_for_RNA_adults.txt")
rownames(sampleinfo) <- sampleinfo$run

dds_adults <- DESeqDataSetFromTximport(txi, colData = sampleinfo,design <- ~condition)
keep <- rowSums(counts(dds_adults)) > 5
dds_adults <- dds_adults[keep,]
...
ylab(paste0("PC2: ",percentVar[2],"% variance")) + 
coord_fixed()+theme_bw()+theme(legend.title = element_blank())+ scale_color_manual(values=c("#55596a", "#6ebe9f","#f3a935", "#D45E79","cornflowerblue","plum"))+ theme(legend.text = element_text(face="bold", size=15))+theme(axis.text = element_text(size=15))+theme(axis.title = element_text(size=16))#+ylim(-50,50)+xlim(-75,75)
ggsave("RNA/Adult-output/pca_adults.png", height = 4, width = 4)
```
...
List <- list(AG,BB,C,LG,LGBB)
Plot <- wrap_plots(List,nrow=1)
ggsave("RNA/Adult-output/adults_MA_all.png", height = 5, width = 15)
```
...
write.csv(as.data.frame(res_LG_sig), file="RNA/Adult-output/res_LG_all.csv")
res_LG_sig<- subset(res_LG_sig, padj < 0.05)
colnames(res_LG_sig)[which(names(res_LG_sig) == "row")] <- "Gene_ID"
res_LG_sig<-merge(res_LG_sig, functions, by="Gene_ID", type="left", match="first")
write.csv(as.data.frame(res_LG_sig), file="RNA/Adult-output/res_LG_sig.csv")

#How many adjusted p-values were less than 0.05?
sum(res_LG_sig$padj < 0.05, na.rm=TRUE)

res_AG_sig <- results(dds_adults, tidy=TRUE, contrast=c("condition", "adult_gut_transfer", "hive_control"))
write.csv(as.data.frame(res_AG_sig), file="RNA/Adult-output/res_AG_all.csv")
res_AG_sig<- subset(res_AG_sig, padj < 0.05)
colnames(res_AG_sig)[which(names(res_AG_sig) == "row")] <- "Gene_ID"
res_AG_sig<-merge(res_AG_sig, functions, by="Gene_ID", type="left", match="first")
write.csv(as.data.frame(res_AG_sig), file="RNA/Adult-output/res_AG_sig.csv")
sum(res_AG_sig$padj < 0.05, na.rm=TRUE)

res_C_sig <- results(dds_adults, tidy=TRUE, contrast=c("condition", "lab_food_nothing", "hive_control"))
write.csv(as.data.frame(res_C_sig), file="RNA/Adult-output/res_C_all.csv")
res_C_sig<- subset(res_C_sig, padj < 0.05)
colnames(res_C_sig)[which(names(res_C_sig) == "row")] <- "Gene_ID"
res_C_sig<-merge(res_C_sig, functions, by="Gene_ID", type="left", match="first")
write.csv(as.data.frame(res_C_sig), file="RNA/Adult-output/res_C_sig.csv")
sum(res_C_sig$padj < 0.05, na.rm=TRUE)

res_LGBB_sig <- results(dds_adults, tidy=TRUE, contrast=c("condition", "larva_gut_bee_bread", "hive_control"))
write.csv(as.data.frame(res_LGBB_sig), file="RNA/Adult-output/res_LGBB_all.csv")
res_LGBB_sig<- subset(res_LGBB_sig, padj < 0.05)
colnames(res_LGBB_sig)[which(names(res_LGBB_sig) == "row")] <- "Gene_ID"
res_LGBB_sig<-merge(res_LGBB_sig, functions, by="Gene_ID", type="left", match="first")
write.csv(as.data.frame(res_LGBB_sig), file="RNA/Adult-output/res_LGBB_sig.csv")
sum(res_LGBB_sig$padj < 0.05, na.rm=TRUE)

res_BB_sig <- results(dds_adults, tidy=TRUE, contrast=c("condition", "bee_bread_addition", "hive_control"))
write.csv(as.data.frame(res_BB_sig), file="RNA/Adult-output/res_BB_all.csv")
res_BB_sig<- subset(res_BB_sig, padj < 0.05)
colnames(res_BB_sig)[which(names(res_BB_sig) == "row")] <- "Gene_ID"
res_BB_sig<-merge(res_BB_sig, functions, by="Gene_ID", type="left", match="first")
write.csv(as.data.frame(res_BB_sig), file="RNA/Adult-output/res_BB_sig.csv")
sum(res_BB_sig$padj < 0.05, na.rm=TRUE)
```
...
```{r GO_AG3}
#up
AG_up <- read.csv("RNA/Adult-output/res_AG_sig_up.csv")
...
GO_enrich.AG %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Adult-output/Go/GO_term_enrichment_AG_up.csv")

### make list
hub_genesGO <- read.csv("RNA/Adult-output/Go/GO_term_enrichment_AG_up.csv")
# keep only highly significant terms
hub_genesGO <- hub_genesGO %>%
filter(Pvalue < 0.05) 
...
ggplot(g, aes(x = 0, y = Term, size = Count, color = logPv)) +
  geom_point(alpha = 0.9) +
  theme_classic()+ggtitle("AG up compared to Hive")+theme(axis.title.y = element_blank())
ggsave("RNA/Adult-output/Go/AG_up.png", height = 8, width = 9)
...
```{r GO_BB}
#up
BB_up <- read.csv("RNA/Adult-output/res_BB_sig_up.csv")
...
GO_enrich.BB %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Adult-output/Go/GO_term_enrichment_BB_up.csv")

hub_genesGO <- read.csv("RNA/Adult-output/Go/GO_term_enrichment_BB_up.csv")
hub_genesGO <- hub_genesGO %>%
filter(Pvalue < 0.05) 
g <- hub_genesGO %>%
  mutate(logPv = log(Pvalue))
ggplot(g, aes(x = 0, y = Term, size = Count, color = logPv)) +
  geom_point(alpha = 0.9) +
  theme_classic()+ggtitle("BB up compared to Hive")+theme(axis.title.y = element_blank())
ggsave("RNA/Adult-output/Go/BB_up.png", height = 8, width = 9)

#down
BB_down <- read.csv("RNA/Adult-output/res_BB_sig_down.csv")
...
GO_enrich.BB2 %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Adult-output/Go/GO_term_enrichment_BB_down.csv")
hub_genesGO2 <- read.csv("RNA/Adult-output/Go/GO_term_enrichment_BB_down.csv")
hub_genesGO2 <- hub_genesGO2 %>%
filter(Pvalue < 0.05) 
...
ggplot(g2, aes(x = 0, y = Term, size = Count, color = logPv)) +
  geom_point(alpha = 0.9) +
  theme_classic()+ggtitle("BB down compared to Hive")+theme(axis.title.y = element_blank())
ggsave("RNA/Adult-output/Go/BB_down.png", height = 8, width = 9)
```
...
#down
C_down <- read.csv("RNA/Adult-output/res_C_sig_down.csv")
...
GO_enrich.C2 %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Adult-output/Go/GO_term_enrichment_C_down.csv")
```

```{r GO_LG}
#up
LG_up <- read.csv("RNA/Adult-output/res_LG_sig_up.csv")
...
GO_enrich.LG %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Adult-output/Go/GO_term_enrichment_LG_up.csv")

hub_genesGO <- read.csv("RNA/Adult-output/Go/GO_term_enrichment_LG_up.csv")
hub_genesGO <- hub_genesGO %>%
filter(Pvalue < 0.05) 
g <- hub_genesGO %>%
  mutate(logPv = log(Pvalue))
ggplot(g, aes(x = 0, y = Term, size = Count, color = logPv)) +
  geom_point(alpha = 0.9) +
  theme_classic()+ggtitle("LG up compared to Hive")+theme(axis.title.y = element_blank())
ggsave("RNA/Adult-output/Go/LG_up.png", height = 8, width = 9)
