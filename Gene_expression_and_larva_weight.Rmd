...
keep <- rowSums(counts(dds_larva)) > 5
dds <- dds_larva[keep,]
...
ggsave("RNA/Larvae_output/pca_larva.png", height = 5, width = 5)
```
...
ggsave("RNA/Larvae_output/larva_MA_all.png", height = 5, width = 15)
```
...
res_LG_sig <- DESeq2::results(dds_larva, tidy=TRUE, contrast=c("condition", "larva_gut_transfer", "hive_control"))
write.csv(as.data.frame(res_LG_sig),file="RNA/Larvae_output/res_LG_all.csv")
...
write.csv(as.data.frame(res_LG_sig),file="RNA/Larvae_output/res_LG_sig.csv")

#How many adjusted p-values were less than 0.05?
sum(res_LG_sig$padj < 0.05, na.rm=TRUE)

res_AG_sig <- DESeq2::results(dds_larva, tidy=TRUE, contrast=c("condition", "adult_gut_transfer", "hive_control"))
write.csv(as.data.frame(res_AG_sig),file="RNA/Larvae_output/res_AG_all.csv")
...
write.csv(as.data.frame(res_AG_sig),file="RNA/Larvae_output/res_AG_sig.csv")
sum(res_AG_sig$padj < 0.05, na.rm=TRUE)

res_C_sig <- DESeq2::results(dds_larva, tidy=TRUE, contrast=c("condition", "lab_food_nothing", "hive_control"))
write.csv(as.data.frame(res_C_sig), file="RNA/Larvae_output/res_C_all.csv")
...
write.csv(as.data.frame(res_C_sig), file="RNA/Larvae_output/res_C_sig.csv")
sum(res_C_sig$padj < 0.05, na.rm=TRUE)

res_LGBB_sig <- DESeq2::results(dds_larva, tidy=TRUE, contrast=c("condition", "larva_gut_bee_bread", "hive_control"))
write.csv(as.data.frame(res_LGBB_sig),file="RNA/Larvae_output/res_LGBB_all.csv")
...
write.csv(as.data.frame(res_LGBB_sig), file="RNA/Larvae_output/res_LGBB_sig.csv")
sum(res_LGBB_sig$padj < 0.05, na.rm=TRUE)

res_BB_sig <- DESeq2::results(dds_larva, tidy=TRUE, contrast=c("condition", "bee_bread_addition", "hive_control"))
write.csv(as.data.frame(res_BB_sig), file="RNA/Larvae_output/res_BB_all.csv")
...
write.csv(as.data.frame(res_BB_sig), file="RNA/Larvae_output/res_BB_sig.csv")
...
```{r GO_AG}
#up
AG_up <- read.csv("RNA/Larvae_output/res_AG_sig_up.csv")
...
GO_enrich.AG %>% 
arrange(Pvalue) #%>% 
#write.csv(file = "RNA/Larvae_output/Go/GO_term_enrichment_AG_up.csv")

#down
AG_down <- read.csv("RNA/Larvae_output/res_AG_sig_down.csv")
...
GO_enrich.AG2 %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Larvae_output/Go/GO_term_enrichment_AG_down.csv")
```

```{r GO_BB}
#up
BB_up <- read.csv("RNA/Larvae_output/res_BB_sig_up.csv")
...
GO_enrich.BB %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Larvae_output/Go/GO_term_enrichment_BB_up.csv")

#down
BB_down <- read.csv("RNA/Larvae_output/res_BB_sig_down.csv")
...
GO_enrich.BB2 %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Larvae_output/Go/GO_term_enrichment_BB_down.csv")
```

```{r GO_C}
#up
C_up <- read.csv("RNA/Larvae_output/res_C_sig_up.csv")
...
GO_enrich.C %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Larvae_output/Go/GO_term_enrichment_C_up.csv")

#down
C_down <- read.csv("RNA/Larvae_output/res_C_sig_down.csv")
...
GO_enrich.C2 %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Larvae_output/Go/GO_term_enrichment_C_down.csv")
```


```{r GO_LG}
#up
LG_up <- read.csv("RNA/Larvae_output/res_LG_sig_up.csv")
...
GO_enrich.LG %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Larvae_output/Go/GO_term_enrichment_LG_up.csv")


#down
LG_down <- read.csv("RNA/Larvae_output/res_LG_sig_down.csv")
...
GO_enrich.LG2 %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Larvae_output/Go/GO_term_enrichment_LG_down.csv")
```

```{r GO_LGBB}
#up
LGBB_up <- read.csv("RNA/Larvae_output/res_LGBB_sig_up.csv")
...
GO_enrich.LGBB %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Larvae_output/Go/GO_term_enrichment_LGBB_up.csv")

#down
LGBB_down <- read.csv("RNA/Larvae_output/res_LGBB_sig_down.csv")
...
GO_enrich.LGBB2 %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Larvae_output/Go/GO_term_enrichment_LGBB_down.csv")
```
...
ggsave("RNA/Larvae_output/compare_against_C_lab_treatment/larva_MA_against_lab_control.png", height = 10, width = 15)
```

```{r extract sig genes2}
functions <- read_csv("RNA/data_files/annotationsBiomart.csv", col_types = cols()) %>% dplyr::select(Gene_ID=ensembl_gene_id,description=description)

res_LG_sig <- DESeq2::results(dds_larva, tidy=TRUE, contrast=c("condition", "larva_gut_transfer", "lab_food_nothing"))
write.csv(as.data.frame(res_LG_sig), file="RNA/Larvae_output/compare_against_C_lab_treatment/res_LG_all.csv")
res_LG_sig<- subset(res_LG_sig, padj < 0.05,pAdjustMethod = "fdr")
colnames(res_LG_sig)[which(names(res_LG_sig) == "row")] <- "Gene_ID"
res_LG_sig<-merge(res_LG_sig, functions, by="Gene_ID", type="left", match="first")
write.csv(as.data.frame(res_LG_sig), file="RNA/Larvae_output/compare_against_C_lab_treatment/res_LG_sig.csv")

#How many adjusted p-values were less than 0.05?
sum(res_LG_sig$padj < 0.05, na.rm=TRUE)

res_AG_sig <- DESeq2::results(dds_larva, tidy=TRUE, contrast=c("condition", "adult_gut_transfer", "lab_food_nothing"))
write.csv(as.data.frame(res_AG_sig), file="RNA/Larvae_output/compare_against_C_lab_treatment/res_AG_all.csv")
res_AG_sig<- subset(res_AG_sig, padj < 0.05,pAdjustMethod = "fdr")
colnames(res_AG_sig)[which(names(res_AG_sig) == "row")] <- "Gene_ID"
res_AG_sig<-merge(res_AG_sig, functions, by="Gene_ID", type="left", match="first")
write.csv(as.data.frame(res_AG_sig), file="RNA/Larvae_output/compare_against_C_lab_treatment/res_AG_sig.csv")
sum(res_AG_sig$padj < 0.05, na.rm=TRUE)

res_LGBB_sig <- DESeq2::results(dds_larva, tidy=TRUE, contrast=c("condition", "larva_gut_bee_bread", "lab_food_nothing"))
write.csv(as.data.frame(res_LGBB_sig), file="RNA/Larvae_output/compare_against_C_lab_treatment/res_LGBB_all.csv")
res_LGBB_sig<- subset(res_LGBB_sig, padj < 0.05)
colnames(res_LGBB_sig)[which(names(res_LGBB_sig) == "row")] <- "Gene_ID"
res_LGBB_sig<-merge(res_LGBB_sig, functions, by="Gene_ID", type="left", match="first")
write.csv(as.data.frame(res_LGBB_sig), file="RNA/Larvae_output/compare_against_C_lab_treatment/res_LGBB_sig.csv")
sum(res_LGBB_sig$padj < 0.05, na.rm=TRUE)

res_BB_sig <- DESeq2::results(dds_larva, tidy=TRUE, contrast=c("condition", "bee_bread_addition", "lab_food_nothing"))
write.csv(as.data.frame(res_BB_sig), file="RNA/Larvae_output/compare_against_C_lab_treatment/res_BB_all.csv")
res_BB_sig<- subset(res_BB_sig, padj < 0.05)
colnames(res_BB_sig)[which(names(res_BB_sig) == "row")] <- "Gene_ID"
res_BB_sig<-merge(res_BB_sig, functions, by="Gene_ID", type="left", match="first")
write.csv(as.data.frame(res_BB_sig), file="RNA/Larvae_output/compare_against_C_lab_treatment/res_BB_sig.csv")
sum(res_BB_sig$padj < 0.05, na.rm=TRUE)
```

```{r GO_AG2}
#up
AG_up <- read.csv("RNA/Larvae_output/compare_against_C_lab_treatment/res_AG_sig_up.csv")
...
GO_enrich.AG %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Larvae_output/compare_against_C_lab_treatment/Go/GO_term_enrichment_AG_up.csv")


#down
AG_down <- read.csv("RNA/Larvae_output/compare_against_C_lab_treatment/res_AG_sig_down.csv")
...
GO_enrich.AG2 %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Larvae_output/compare_against_C_lab_treatment/Go/GO_term_enrichment_AG_down.csv")
```

```{r GO_BB2}
#up
BB_up <- read.csv("RNA/Larvae_output/compare_against_C_lab_treatment/res_BB_sig_up.csv")
...
GO_enrich.BB %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Larvae_output/compare_against_C_lab_treatment/Go/GO_term_enrichment_BB_up.csv")

#down
BB_down <- read.csv("RNA/Larvae_output/compare_against_C_lab_treatment/res_BB_sig_down.csv")
...
GO_enrich.BB2 %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Larvae_output/compare_against_C_lab_treatment/Go/GO_term_enrichment_BB_down.csv")
```

```{r GO_LG2}
#up
LG_up <- read.csv("RNA/Larvae_output/compare_against_C_lab_treatment/res_LG_sig_up.csv")
...
GO_enrich.LG %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Larvae_output/compare_against_C_lab_treatment/Go/GO_term_enrichment_LG_up.csv")

#down
LG_down <- read.csv("RNA/Larvae_output/compare_against_C_lab_treatment/res_LG_sig_down.csv")
...
GO_enrich.LG2 %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Larvae_output/compare_against_C_lab_treatment/Go/GO_term_enrichment_LG_down.csv")
```

```{r GO_LGBB2}
#up
LGBB_up <- read.csv("RNA/Larvae_output/compare_against_C_lab_treatment/res_LGBB_sig_up.csv")
...
GO_enrich.LGBB %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Larvae_output/compare_against_C_lab_treatment/Go/GO_term_enrichment_LGBB_up.csv")

#down
LGBB_down <- read.csv("RNA/Larvae_output/compare_against_C_lab_treatment/res_LGBB_sig_down.csv")
...
GO_enrich.LGBB2 %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Larvae_output/compare_against_C_lab_treatment/Go/GO_term_enrichment_LGBB_down.csv")
```
...
ylab(paste0("PC2: ",percentVar[2],"% variance")) + 
coord_fixed()+theme_bw()+theme(legend.title = element_blank())+ scale_color_manual(values=c("#55596a", "#6ebe9f","#f3a935", "#D45E79","cornflowerblue","plum"))+ theme(legend.text = element_text(face="bold", size=15))+theme(axis.text = element_text(size=15))+theme(axis.title = element_text(size=16))#+ylim(-50,50)+xlim(-75,75)
ggsave("RNA/Adult_output/pca_adults.png", height = 4, width = 4)
```
...
List <- list(AG,BB,C,LG,LGBB)
Plot <- wrap_plots(List,nrow=1)
ggsave("RNA/Adult_output/adults_MA_all.png", height = 5, width = 15)
```
...
res_LG_sig <- DESeq2::results(dds_adults, tidy=TRUE, contrast=c("condition", "larva_gut_transfer", "hive_control"))
write.csv(as.data.frame(res_LG_sig), file="RNA/Adult_output/res_LG_all.csv")
res_LG_sig<- subset(res_LG_sig, padj < 0.05)
colnames(res_LG_sig)[which(names(res_LG_sig) == "row")] <- "Gene_ID"
res_LG_sig<-merge(res_LG_sig, functions, by="Gene_ID", type="left", match="first")
write.csv(as.data.frame(res_LG_sig), file="RNA/Adult_output/res_LG_sig.csv")

#How many adjusted p-values were less than 0.05?
sum(res_LG_sig$padj < 0.05, na.rm=TRUE)

res_AG_sig <- DESeq2::results(dds_adults, tidy=TRUE, contrast=c("condition", "adult_gut_transfer", "hive_control"))
write.csv(as.data.frame(res_AG_sig), file="RNA/Adult_output/res_AG_all.csv")
res_AG_sig<- subset(res_AG_sig, padj < 0.05)
colnames(res_AG_sig)[which(names(res_AG_sig) == "row")] <- "Gene_ID"
res_AG_sig<-merge(res_AG_sig, functions, by="Gene_ID", type="left", match="first")
write.csv(as.data.frame(res_AG_sig), file="RNA/Adult_output/res_AG_sig.csv")
sum(res_AG_sig$padj < 0.05, na.rm=TRUE)

res_C_sig <- DESeq2::results(dds_adults, tidy=TRUE, contrast=c("condition", "lab_food_nothing", "hive_control"))
#write.csv(as.data.frame(res_C_sig), file="RNA/Adult_output/res_C_all.csv")
res_C_sig<- subset(res_C_sig, padj < 0.05)
colnames(res_C_sig)[which(names(res_C_sig) == "row")] <- "Gene_ID"
res_C_sig<-merge(res_C_sig, functions, by="Gene_ID", type="left", match="first")
write.csv(as.data.frame(res_C_sig), file="RNA/Adult_output/res_C_sig.csv")
sum(res_C_sig$padj < 0.05, na.rm=TRUE)

res_LGBB_sig <- DESeq2::results(dds_adults, tidy=TRUE, contrast=c("condition", "larva_gut_bee_bread", "hive_control"))
write.csv(as.data.frame(res_LGBB_sig), file="RNA/Adult_output/res_LGBB_all.csv")
res_LGBB_sig<- subset(res_LGBB_sig, padj < 0.05)
colnames(res_LGBB_sig)[which(names(res_LGBB_sig) == "row")] <- "Gene_ID"
res_LGBB_sig<-merge(res_LGBB_sig, functions, by="Gene_ID", type="left", match="first")
write.csv(as.data.frame(res_LGBB_sig), file="RNA/Adult_output/res_LGBB_sig.csv")
sum(res_LGBB_sig$padj < 0.05, na.rm=TRUE)

res_BB_sig <- DESeq2::results(dds_adults, tidy=TRUE, contrast=c("condition", "bee_bread_addition", "hive_control"))
write.csv(as.data.frame(res_BB_sig), file="RNA/Adult_output/res_BB_all.csv")
res_BB_sig<- subset(res_BB_sig, padj < 0.05)
colnames(res_BB_sig)[which(names(res_BB_sig) == "row")] <- "Gene_ID"
res_BB_sig<-merge(res_BB_sig, functions, by="Gene_ID", type="left", match="first")
write.csv(as.data.frame(res_BB_sig), file="RNA/Adult_output/res_BB_sig.csv")
sum(res_BB_sig$padj < 0.05, na.rm=TRUE)
```
...
```{r GO_AG3}
#up
AG_up <- read.csv("RNA/Adult_output/res_AG_sig_up.csv")
...
GO_enrich.AG %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Adult_output/Go/GO_term_enrichment_AG_up.csv")
...
```{r GO_BB}
#up
BB_up <- read.csv("RNA/Adult_output/res_BB_sig_up.csv")
...
GO_enrich.BB %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Adult_output/Go/GO_term_enrichment_BB_up.csv")

#down
BB_down <- read.csv("RNA/Adult_output/res_BB_sig_down.csv")
...
GO_enrich.BB2 %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Adult_output/Go/GO_term_enrichment_BB_down.csv")
```
...
#down
C_down <- read.csv("RNA/Adult_output/res_C_sig_down.csv")
...
GO_enrich.C2 %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Adult_output/Go/GO_term_enrichment_C_down.csv")
```

```{r GO_LG}
#up
LG_up <- read.csv("RNA/Adult_output/res_LG_sig_up.csv")
...
GO_enrich.LG %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Adult_output/Go/GO_term_enrichment_LG_up.csv")
