...
```{r GO_BB}
#up
BB_up <- read.csv("RNA/Larvae-output/res_BB_sig_up.csv")
...
GO_enrich.BB %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Larvae-output/Go/GO_term_enrichment_BB_up.csv")

#down
BB_down <- read.csv("RNA/Larvae-output/res_BB_sig_down.csv")
...
GO_enrich.BB2 %>% 
arrange(Pvalue) %>% 
write.csv(file = "RNA/Larvae-output/Go/GO_term_enrichment_BB_down.csv")
```
