...
ggsave("pca_all.png", height = 6.5, width = 6.5)
```
...
```{r pca_larva, fig.width=6, fig.height=5.5}
...
ggsave("Larvae-output/pca_larva.png", height = 5, width = 5)
```

### MA plots treatments vs hive control

```{r MA_plots, fig.width=4, fig.height=4}
...
ggsave("Larvae-output/larva_MA_all.png", height = 5, width = 15)
```
...
write.csv(as.data.frame(res_LG_sig), file="Larvae-output/res_LG_all.csv")
...
write.csv(as.data.frame(res_LG_sig), file="Larvae-output/res_LG_sig.csv")
...
write.csv(as.data.frame(res_AG_sig), file="Larvae-output/res_AG_all.csv")
...
write.csv(as.data.frame(res_AG_sig), file="Larvae-output/res_AG_sig.csv")
...
write.csv(as.data.frame(res_C_sig), file="Larvae-output/res_C_all.csv")
...
write.csv(as.data.frame(res_C_sig), file="Larvae-output/res_C_sig.csv")
...
write.csv(as.data.frame(res_LGBB_sig), file="Larvae-output/res_LGBB_all.csv")
...
write.csv(as.data.frame(res_LGBB_sig), file="Larvae-output/res_LGBB_sig.csv")
...
write.csv(as.data.frame(res_BB_sig), file="Larvae-output/res_BB_all.csv")
...
write.csv(as.data.frame(res_BB_sig), file="Larvae-output/res_BB_sig.csv")
...
#up
AG_up <- read.csv("Larvae-output/res_AG_sig_up.csv")
...
GO_enrich.AG %>% 
arrange(Pvalue) %>% 
write.csv(file = "Larvae-output/Go/GO_term_enrichment_AG_up.csv")

### make list
hub_genesGO <- read.csv("Larvae-output/Go/GO_term_enrichment_AG_up.csv")
...
ggsave("Larvae-output/Go/AG_up.png", height = 8, width = 9)

#down
AG_down <- read.csv("Larvae-output/res_AG_sig_down.csv")
...
GO_enrich.AG2 %>% 
arrange(Pvalue) %>% 
write.csv(file = "Larvae-output/Go/GO_term_enrichment_AG_down.csv")
...
ggsave("Larvae-output/Go/AG_down.png", height = 8, width = 9)
```
